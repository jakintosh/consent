...
func (t *AccessToken) Decode(s string, v TokenValidator) error {
	return (*tokens.AccessToken)(t).Decode(s, v)
}
...
func (t *RefreshToken) Decode(s string, v TokenValidator) error {
	return (*tokens.RefreshToken)(t).Decode(s, v)
}
