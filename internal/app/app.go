...
func (a *App) Router() http.Handler {
	...
	mux.HandleFunc("GET /admin", a.serve(a.handleGetAdmin))
	mux.HandleFunc("GET /admin/users", a.serve(a.handleListAdminUsers))
	mux.HandleFunc("GET /admin/users/{subject}/edit", a.serve(a.handleEditAdminUser))
	mux.HandleFunc("POST /admin/users/{subject}", a.serve(a.handleUpdateAdminUser))
	mux.HandleFunc("POST /admin/users/{subject}/delete", a.serve(a.handleDeleteAdminUser))
	mux.HandleFunc("GET /admin/roles", a.serve(a.handleListAdminRoles))
	mux.HandleFunc("GET /admin/roles/new", a.serve(a.handleNewAdminRole))
	mux.HandleFunc("POST /admin/roles", a.serve(a.handleCreateAdminRole))
	mux.HandleFunc("GET /admin/roles/{name}/edit", a.serve(a.handleEditAdminRole))
	mux.HandleFunc("POST /admin/roles/{name}", a.serve(a.handleUpdateAdminRole))
	mux.HandleFunc("POST /admin/roles/{name}/delete", a.serve(a.handleDeleteAdminRole))
	mux.HandleFunc("GET /admin/integrations", a.serve(a.handleListAdminIntegrations))
	mux.HandleFunc("GET /admin/integrations/new", a.serve(a.handleNewAdminIntegration))
	mux.HandleFunc("POST /admin/integrations/import", a.serve(a.handleImportAdminIntegration))
	mux.HandleFunc("POST /admin/integrations", a.serve(a.handleCreateAdminIntegration))
	mux.HandleFunc("GET /admin/integrations/{name}/edit", a.serve(a.handleEditAdminIntegration))
	mux.HandleFunc("POST /admin/integrations/{name}", a.serve(a.handleUpdateAdminIntegration))
	mux.HandleFunc("POST /admin/integrations/{name}/delete", a.serve(a.handleDeleteAdminIntegration))
